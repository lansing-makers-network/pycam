    ...
    def _export_toolpaths(self, toolpaths):
        ...
        try:
            ...
            generator = generator_func(destination,
                    ...
                    static_z_height=self.core.get("gcode_static_z_height"),
                    feedrate_with_moves=self.core.get("gcode_feedrate_with_moves"),
                    rapid_feedrate = self.core.get("gcode_rapid_feedrate"),
